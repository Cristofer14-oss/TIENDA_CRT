...
class App:
    ...
    def menu_principal(self):
        ...
        tk.Label(frame, text="Tienda Virtual de Tenis", font=("Arial", 22, "bold"),
                 bg="#E6F2FF", fg="#003366").pack(pady=30)

        ttk.Button(frame, text="Ingresar como Admin",
                   command=self.login_admin).pack(pady=10)
        ttk.Button(frame, text="Ingresar como Cliente",
                   command=self.login_cliente).pack(pady=10)
        ttk.Button(frame, text="Salir", command=self.root.quit).pack(pady=20)
    ...
    def login_admin(self):
        ...
        tk.Label(frame, text="Login Admin", font=("Arial", 18, "bold"),
                 bg="#EAF7FF", fg="#003366").pack(pady=20)

        tk.Label(frame, text="Usuario", bg="#EAF7FF").pack()
        user_entry = tk.Entry(frame)
        user_entry.pack()

        tk.Label(frame, text="Contraseña", bg="#EAF7FF").pack()
    ...
    def menu_admin(self):
        ...
        tk.Label(frame, text="Menú Admin", font=("Arial", 18, "bold"),
                 bg="#E6F7FF", fg="#003366").pack(pady=20)
    ...
    def admin_agregar(self):
        frame = tk.Frame(self.root, bg="#EAF7FF")
        tk.Label(frame, text="Agregar Tenis", font=("Arial", 18, "bold"),
                 bg="#EAF7FF", fg="#003366").pack(pady=20)

        entradas = {}
        for campo in ["Marca", "Modelo", "Color", "Talla", "Precio"]:
            tk.Label(frame, text=campo, bg="#EAF7FF").pack()
            e = tk.Entry(frame)
            e.pack()
            entradas[campo] = e
    ...
    def admin_eliminar(self):
        ...
        for c in cols:
            ...
            tabla.column(c, anchor="center", width=100)
    ...
    def login_cliente(self):
        ...
        tk.Label(frame, text="Ingresar como Cliente", font=("Arial", 18, "bold"),
                 bg="#EAF7FF", fg="#003366").pack(pady=20)

        tk.Label(frame, text="Nombre", bg="#EAF7FF").pack()
    ...
    def menu_cliente(self):
        frame = tk.Frame(self.root, bg="#E6F7FF")
        tk.Label(frame, text=f"Menú Cliente ({self.cliente.nombre})", font=("Arial", 18, "bold"),
                 bg="#E6F7FF", fg="#003366").pack(pady=20)
        ...
        ttk.Button(frame, text="Volver", width=30, command=self.menu_principal).pack(pady=20)
    ...
    def cliente_ver_tenis(self):
        frame = tk.Frame(self.root, bg="#FFFFFF")
        tk.Label(frame, text="Tenis Disponibles", font=("Arial", 18, "bold"),
                 bg="#FFFFFF", fg="#003366").pack(pady=20)
    ...
    def cliente_hacer_pedido(self):
        frame = tk.Frame(self.root, bg="#FFFFFF")
        tk.Label(frame, text="Seleccionar Tenis", font=("Arial", 18, "bold"),
                 bg="#FFFFFF", fg="#003366").pack(pady=20)
